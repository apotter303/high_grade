      ...
      <Container>
        <FadeIn className="flex flex-col items-center text-center">
          <h2 className="font-display text-2xl font-semibold tracking-tight text-white sm:text-3xl">
            Georgia has a medical marijuana program
          </h2>
          <p className="mt-4 max-w-2xl text-lg text-white/80">
            Qualify for legal cannabis access through Georgia's medical marijuana program. 
            Our doctors can evaluate your condition and help you get your card.
          </p>
          <div className="mt-8">
            <Button href="/contact" invert className="px-6 py-3 text-base">
              Schedule Your Card Evaluation
            </Button>
          </div>
        </FadeIn>
      </Container>
          ...
          <div className="flex justify-center lg:w-1/2 lg:justify-end lg:pr-12">
            <FadeIn className="w-[33.75rem] flex-none lg:w-[45rem]">
              <StylizedImage
                ...
                priority
                alt="Laptop displaying service information"
              />
            </FadeIn>
          </div>
